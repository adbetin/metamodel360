 ...
 * </p>
 * <ul>
 *   <li>{@link metamodel360.impl.TourImpl#getName <em>Name</em>}</li>
 *   <li>{@link metamodel360.impl.TourImpl#getPanoramas <em>Panoramas</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TourImpl extends MinimalEObjectImpl.Container implements Tour {
	...
	protected EClass eStaticClass() {
		return Metamodel360Package.Literals.TOUR;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Metamodel360Package.TOUR__NAME, oldName, name));
	}
	...
	public EList<Panorama> getPanoramas() {
		if (panoramas == null) {
			panoramas = new EObjectContainmentEList<Panorama>(Panorama.class, this, Metamodel360Package.TOUR__PANORAMAS);
		}
		return panoramas;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case Metamodel360Package.TOUR__PANORAMAS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Metamodel360Package.TOUR__NAME:
				return getName();
			case Metamodel360Package.TOUR__PANORAMAS:
				return getPanoramas();
		}
